...
CHART_DIR="# TODO: path to the chart, e.g. ../04-helm-create-chart/mychart"
REGISTRY="# TODO: registry host:port, e.g. localhost:32000"
REPO_PATH="# TODO: path inside the registry, e.g. helm-charts"
